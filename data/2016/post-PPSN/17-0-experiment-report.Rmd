...
this.data <- read.csv(paste0("nodio-2016-3-17-0_by_exp.csv"))

this.ip.data <- read.csv(paste0("nodio-2016-3-17-0_by_IP.csv"))
this.len <- length(this.ip.data$PUTs)
seq <- 1:this.len
ips.data <- rbind(ips.data,
                      data.frame(Experiment=rep("17-0",length(this.ip.data$PUTs)),
                                 idu=seq,
                                 idx=seq/this.len,
    ...
    experiment.data <- rbind( experiment.data,
                              data.frame( Experiment=rep("17-0", length(this.data$IPs)),                   
    ...
    IPs <- read.csv(paste0("nodio-2016-3-17-0_per_minute.csv"))
    ...
    seconds <- read.csv(paste0("nodio-2016-3-17-0_per_second.csv"))
