...
ggplot(duration.df,aes(x=population,y=times))+geom_boxplot(notch=T)+scale_y_log10()+ ylab("Time (s)") + theme(axis.text=element_text(size=14), axis.title=element_text(size=16,face="bold"))
